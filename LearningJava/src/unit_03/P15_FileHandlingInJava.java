...
class FileInJava
{
	...
	{
		String path="C:\\Users\\hp\\git\\JavaPrograms\\LearningJava\\src\\unit_03\\input.txt";
	...
	void saveOutputIntoAFile()
	{
		...
		try {
			myObj = new FileWriter("C:\\Users\\hp\\git\\JavaPrograms\\LearningJava\\src\\unit_03\\output.txt");
		} 
		catch (IOException e) {
			e.printStackTrace();
		}
	...
	void createALogFile()
	{
		...
		try {
			myObj = new FileWriter("C:\\Users\\hp\\git\\JavaPrograms\\LearningJava\\src\\unit_03\\log.txt",true);
		} catch (IOException e) {
