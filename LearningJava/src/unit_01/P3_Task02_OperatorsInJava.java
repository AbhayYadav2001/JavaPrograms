package unit_01;
  ...
  *     -Unary Operators: {prefix and post fix}{a++,a--,++a,--a,-a,!a}
        ...
        -Bitwise Operator:{&,^,|}{bitwise AND,bitwise OR,inclusive OR}
        -Logical Operator:{&&,||}
        -Ternary Operator:{? :}
...
class OperatorsInJava{
	...
	//Bitwise : Second condition is also checked but not in logical && and even in logical OR(||)
	void BitwiseAndLogicalOperator()
	{
		System.out.println("Inside BitwiseAndLogical Operators");
	...
	{
		System.out.println("Inside Assignment Operators");
